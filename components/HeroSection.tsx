                    ...
                    >
                        ...
                        <div className="flex ml-8 space-x-6 mt-5 items-center">
                            ...
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2 }}
                            >
                                <img src="https://gcdnb.pbrd.co/images/d1O0FgSl8N4B.png?o=1" alt="LinkedIn" className="w-6 h-6 " />
                            </motion.a>
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2 }}
                            >
                                <img src="https://gcdnb.pbrd.co/images/hxdnD7KF64jq.png?o=1" alt="Github" className="w-6 h-6" />
                            </motion.a>
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2 }}
                            >
                                <img src="https://gcdnb.pbrd.co/images/UiKpFCYfLq09.png?o=1" alt="Instagram" className="w-6 h-6" />
                            </motion.a>
                            <motion.a
                                ...
                                whileHover={{ scale: 1.2 }}
                            >
                                <img src="https://gcdnb.pbrd.co/images/QyQeL5HGFoCc.png?o=1" alt="Youtube" className="w-6 h-6" />
                            </motion.a>
                        </div>
                    </motion.div>
                </div>
